...
- 2026-04-07: Усилен reader UX: более жирная 3D-анимация перелистывания, mobile action bar, richer progress UI, доп. desktop/mouse/touch controls.
- 2026-04-07: Добавлен GitHub Actions workflow для автоматической сборки и деплоя через GitHub Pages; подготовлен README под GitHub build flow.
